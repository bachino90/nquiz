...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if CountryManager.sharedManager.country == nil {
            ...
            quizVC.presentViewController(countrySelectorVC, animated: true, completion: nil)
        }
        ...
        Parse.setApplicationId("XZXbogEx2eXl8SGNivbYrWLyH9iEvVh1INESBMDU", clientKey: "Iw7tyBV6LdUgQe7M7ejwhrOpW5eaOsZdgHplfh4X")
